...
const Testimonialscol = (props: {
	...
	<div
		className={twMerge(
			"flex flex-col px-10 gap-6 mt-10 [mask-image:linear-gradient(to_bottom,transparent,black,black,black,transparent)]",
			props.className
		)}
	>
		...
		<section className="bg-white">
			<div className="container">
				...
				<div className="flex justify-center gap-6 ">
					<Testimonialscol testimonials={firstColumn} />
					<Testimonialscol
